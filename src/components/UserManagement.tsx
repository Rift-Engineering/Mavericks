        ...
        <table className="w-full min-w-[600px] text-left text-sm">
          <thead>
            <tr className="border-b border-white/10 bg-white/[0.05]">
              <th className="px-4 py-3 font-medium text-[#a0a0a0]">Name</th>
              <th className="px-4 py-3 font-medium text-[#a0a0a0]">Email</th>
              <th className="px-4 py-3 font-medium text-[#a0a0a0]">Role</th>
              <th className="px-4 py-3 font-medium text-[#a0a0a0]">Actions</th>
            </tr>
          </thead>
          <tbody>
            {users.map((u) => (
