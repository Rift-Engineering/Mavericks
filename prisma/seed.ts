...
/**
 * Home / start point for each seed user (1–20). All use major JR/metro station coordinates so:
 * - Carpool riders and public-transport users get Distance Matrix *transit* legs (stations are
 *   unambiguous transit origins; residential pins often fall back to driving).
 * - Locations span central Tokyo and Greater Tokyo (Yokohama, Omiya, Chiba, Hachioji, etc.) so
 *   commute times to training venues reflect realistic long cross-city trips.
 */
const USER_HOMES: {
  id: string;
  email: string;
  ...
  },
  {
    ...
    name: "Daiki Yamamoto",
    role: "PLAYER",
    homeName: "Aoyama-Itchome Station",
    lat: 35.6652,
    lng: 139.7129,
  },
  {
    ...
    name: "Sakura Ito",
    role: "PLAYER",
    homeName: "Shimokitazawa Station",
    lat: 35.6618,
    lng: 139.6672,
  },
  {
